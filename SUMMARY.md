**Semantic-segmentation-with-PyTorch-Satellite-Imagery** is a dataset for semantic segmentation and instance segmentation tasks. It is used in the air detection industry.
